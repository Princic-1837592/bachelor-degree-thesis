...
toKeisanCasio x n s = "phi = (sqrt(5)+1)/2;\n" ++ s ++ " = " ++ toString x n ++ ";\n" ++ s ++ ";\n"
...
main = do {
    ...
    putStrLn $ toKeisanCasio one 200 "one";
    putStrLn $ toKeisanCasio zero 200 "zero";
    putStrLn $ toKeisanCasio minusOne 200 "minusOne";
    -- putStrLn $ toString zero 200;
    -- putStrLn $ toString two 200;
    -- putStrLn $ toString (multiplication two two) 2000;
    print True;
}
